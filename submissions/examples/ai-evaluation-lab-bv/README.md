...
The core objective of **AI Evaluation Laboratory** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(330, 85%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(250, 90%, 65%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(180, 80%, 45%)` - Callouts and interactive states.
