...
The core objective of **Business Continuity Command Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(195, 90%, 45%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(335, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(45, 90%, 50%)` - Callouts and interactive states.
