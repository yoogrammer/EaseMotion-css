...
The core objective of **Autonomous Vehicle Operations Dashboard** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(190, 85%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(120, 75%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(30, 95%, 50%)` - Callouts and interactive states.
