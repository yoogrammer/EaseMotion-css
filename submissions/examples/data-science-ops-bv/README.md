...
The core objective of **Data Science Operations Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(210, 95%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(145, 80%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(280, 85%, 60%)` - Callouts and interactive states.
