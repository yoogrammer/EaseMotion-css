# Slide Animation File Header

## What does this do?
Proposes adding a file-level documentation comment block at the top
of `easemotion/slide.css`. Linked to issue #5571.

## How is it used?
Documentation-only change. The maintainer pastes the proposed
header into `easemotion/slide.css`.

## Why is it useful?
`slide.css` was missing the file-level documentation banner used by
other animation files. Adding it improves discoverability and
consistency.
