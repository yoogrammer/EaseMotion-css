...
The core objective of **AI City Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(215, 85%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(155, 80%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(35, 95%, 50%)` - Callouts and interactive states.
