...
The core objective of **Multi-Cloud Operations Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(220, 90%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(130, 80%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(30, 90%, 50%)` - Callouts and interactive states.
