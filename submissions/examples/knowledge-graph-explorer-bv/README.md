...
The core objective of **Knowledge Graph Explorer** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(200, 90%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(290, 80%, 60%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(140, 75%, 45%)` - Callouts and interactive states.
