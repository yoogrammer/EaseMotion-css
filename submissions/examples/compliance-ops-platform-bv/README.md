...
The core objective of **Compliance Operations Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(160, 80%, 45%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(215, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(40, 90%, 55%)` - Callouts and interactive states.
