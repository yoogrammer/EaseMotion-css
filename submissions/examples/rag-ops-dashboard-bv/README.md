...
The core objective of **RAG Operations Dashboard** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(165, 80%, 45%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(220, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(30, 90%, 55%)` - Callouts and interactive states.
