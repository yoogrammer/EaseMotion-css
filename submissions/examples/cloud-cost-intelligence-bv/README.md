...
The core objective of **Cloud Cost Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(145, 85%, 45%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(205, 90%, 50%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(345, 85%, 55%)` - Callouts and interactive states.
